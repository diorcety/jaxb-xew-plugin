...
public class UntypedListField extends AbstractListField {
     ...
     *      An instance of this class will be used to store data
     */
    protected UntypedListField(ClassOutlineImpl context, CPropertyInfo prop, JClass interfaceList, JClass coreList) {
        ...
        this.listT = interfaceList.narrow(exposedType.boxify());
        generate();
    }
